...
\newcommand{\LfNoSigma}[2]{\ensuremath{\Lfonly_{\mathit #1}^{#2}}}
...
\newcommand{\pu}{\mbox{\tt u}}
\renewcommand{\pv}{\mbox{\tt v}}
\newcommand{\varnew}[1]{\raisebox{.4mm}{\scalebox{.8}{\ensuremath{\langle#1\rangle'}}}}
\newcommand{\rotmore}[1]{\rotatebox{20}{\scalebox{0.8}{#1}}}
