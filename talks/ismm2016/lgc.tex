...
\begin{frame}{Liveness Analysis of User Defined Functions}
  ...
  \raisebox{-25mm}{\scalebox{.85}{
	...
	%% \onslide<1-5>{\putnode{o}{origin}{26}{72}{\large\red $\sigma_{\xmain} =
        %%     \sigma{_{all}}$}}
	\onslide<2-5>{\putnode{call1}{origin}{105}{98}{\large\red $\clazy\sigma$}}
	\onslide<3-5>{\putnode{appendentry}{origin}{94}{106}{\large\red
            $\Lf{\plength}{1}{\sigma} =$}}
        \putnode{sigma1}{appendentry}{16}{0}{\large\red $\sigma_1$}
        \putnode{un}{sigma1}{6}{0}{\large\red $\cup \only<3>{\ldots}$} 
	\nccurve[nodesepB=-.2,angleA=-5,angleB=-145,linecolor=red]{->}{call1}{sigma1}
	\onslide<4-5>{\putnode{call2}{origin}{109}{86}{\large\red $\acdr\Lf{\plength}{1}{\clazy\sigma}$}
          \putnode{sigma2}{sigma1}{6}{0}{\large\red $\sigma_2$}}
