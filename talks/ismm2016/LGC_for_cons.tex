...
% \psframe(0,15)(150,-45)
  ...
  \nccurve[angleA=60,angleB=120,ncurv=3, nodesep=-.05]{->}{t1}{t1}
  \Aput[0.05]{\acdr}
  %      \nccoil[angleA=45, angleB=135, ncurv=1.5, nodesep=-1]{t2}{t3} 
  %\nczigzag[nodesep=0.1,coilwidth=4mm,coilheight=.3,coilarm=2mm]{t2}{t3} 
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \nccurve[nodesep=-0.05,linestyle=dashed,angleA=0,angleB=-120]{o}{t1}
  \nccurve[nodesep=-0.05, linestyle=dashed,angleA=0,angleB=-105]{b}{t1}
\end{pspicture}
}
\lgccons
