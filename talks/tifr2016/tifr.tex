...
\end{eqnarray*}}
%% \item \onslide<5->{\acar(\acdr) removal as the relation  ($\stackrel{*}{\hookrightarrow}$):
%% \begin{eqnarray*}
%%   \sigma_1\bcar\sigma_2  &\hookrightarrow& 
%%   \sigma_1\lbrace \alpha \mid
...
\raisebox{25mm}{\scalebox{.65}{
    ...
    \begin{pspicture}(0,0)(90,0)
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      \putnode{x}{origin}{-3}{40}{}
      \putnode{y}{x}{51}{0}{}
      \putnode{startx}{x}{3}{-3}{}
      \putnode{starty}{y}{-3}{-3}{}
      \putnode{after0}{x}{-5}{-30}{}
      \putnode{after1}{y}{5}{-30}{}
      \putnode{resultx}{origin}{18}{60}{}	
      \putnode{resulty}{origin}{26}{60}{}
      
      \nccurve[nodesepB=-.2,angleA=270,angleB=75]{*->}{resultx}{x}
      \onslide<3->{        \bput(.5){\large \acar}}
      \nccurve[nodesepB=-.2,angleA=270,angleB=105]{*->}{resulty}{y}
      \onslide<3->{        \aput(.5){\large \acdr}}
      \onslide<3->{	\nccurve[nodesepB=-.2,angleA=270,angleB=75,linestyle=dashed]{*->}{startx}{after0}
        \bput(.5){\large $\alpha$}
	\nccurve[nodesepB=-.2,angleA=270,angleB=105,linestyle=dashed]{*->}{starty}{after1}
...
{\begin{columns}[c]
  \begin{column}{0.5\textwidth}
    \onslide<1->{\centerline{\epsfig{file=live-analysis4.eps,
          height=2.6cm}}}
%    \only<3->{\centerline{\epsfig{file=live-analysis5.eps,
%          height=3.5cm}}}
...
\small
   \mbox{\onslide<1->{$\Lapp{{\red{(f \;x \;y)}}}{\sigma} =$}
     \onslide<2->{$\{x.\Lf{f}{1}{\sigma},  \;  y.\Lf{f}{2}{\sigma}\}$}}
  \end{column}
\end{columns}
}
      \raisebox{-25mm}{\scalebox{.65}{
	%%%%%%%%%%%%%%%%%%%%%Uday's stuff%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      \psset{linewidth=.5mm}
      \begin{pspicture}(0,0)(90,0)
%\psgrid[xunit=1cm,yunit=1cm,gridwidth=.2pt,subgridwidth=.1pt,subgriddiv=5,subgridcolor=gray,gridcolor=blue](-1,0)(9,10)
	%\psframe(0,0)(73,60)
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\putnode{x}{origin}{8}{45}{}
	\putnode{y}{x}{54}{0}{}
	\putnode{resultx}{origin}{34}{62}{}	
        \putnode{resulty}{origin}{34}{62}{}
    \onslide<1->{\putnode{call}{resultx}{1}{3}{\Large $(f~ x~ y)$}}

%% %    \onslide<3->{\putnode{body}{origin}{35}{46}{\epsfig{file=live-analysis5.eps,height=5cm}}}

\onslide<2->{
        \nccurve[nodesepB=-.2,angleA=270,angleB=75,linestyle=dashed]{->}{resultx}{x}
        \bput(.6){\large \Lf{f}{1}{\sigma}}
            }
\onslide<2->{
        \nccurve[nodesepB=-.2,angleA=270,angleB=105,linestyle=dashed]{->}{resulty}{y}
        \aput(.6){\large \Lf{f}{2}{\sigma}}
           }
%% %% \onslide<3->{
%% %%   \putnode{symsigma}{origin}{35}{54}{}
%% %%         \putnode{xx1}{origin}{15}{13}{\Large \Lexp{e_f}{\sigma}($x_1$)}
%% %%         \putnode{xx2}{origin}{55}{13}{\Large \Lexp{e_f}{\sigma}($x_2$)}
%% %%         \putnode{ef}{origin}{35}{31}{\huge $e_{f}$}

%% %%         \nccurve[nodesepB=0,angleA=270,angleB=75,linestyle=dashed]{->}{symsigma}{xx1}
%% %%         \bput(.5){\large \Lf{f}{1}{\}}
%% %%         \nccurve[nodesepB=0,angleA=270,angleB=105,linestyle=dashed]{->}{symsigma}{xx2}
%% %%         \aput(.5){\large \Lf{f}{2}{\}}
%% %%}
       \end{pspicture}}}
%%}
...
%% %%  \centerline{\epsfig{file=live-analysis4.eps, height=2.5cm}}
%% %%   \end{column}
%% %%  \begin{column}{0.60\textwidth}
%% %% \begin{align*}
%% %% \Lapp{{\red{(f \;x \;y)}}}{\sigma} &= \{x.\Lf{f}{1}{\sigma}, \;
%% %%   y.\Lf{f}{2}{\sigma}\}
%% %% \end{align*}
%% %%    \end{column}
%% %% \end{columns}}
...
\vspace*{-1.5cm}
  \begin{itemize}
\onslide<2->{  \item  \Lfonly$_{\mathit  f}$ is a context independent summary of
    the function $f$.}
\onslide<3-> {\item To find \Lf{\mathit  f}{i}{\sigma}: 
    \begin{itemize}
