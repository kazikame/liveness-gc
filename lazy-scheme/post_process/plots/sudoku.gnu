...
plot [:1.75e5] [:4.2e3] "output/sudoku_gc-live_output/rch.sort"  w l ls 1 notitle,     "output/sudoku_gc-plain_output/rch.sort" w l ls 2 notitle,     "output/sudoku_gc-freq_output/rch.sort"  w l ls 3 notitle,           "output/sudoku_gc-live_output/use.sort"  w l ls 5 notitle
