...
plot "output/lcss_gc-live_output/rch.sort"  w l ls 2 notitle,     "output/lcss_gc-plain_output/rch.sort" w l ls 1 notitle,     "output/lcss_gc-freq_output/rch.sort"  w l ls 3 notitle,          "output/lcss_gc-live_output/use.sort"  w l ls 4 notitle
