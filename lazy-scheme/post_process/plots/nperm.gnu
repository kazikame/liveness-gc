...
plot [:34e5] [:28e3] "output/nperm_gc-live_output/rch.sort"  w l ls 2 notitle,     "output/nperm_gc-plain_output/rch.sort" w l ls 1 notitle,     "output/nperm_gc-freq_output/rch.sort"  w l ls 3 notitle,      "output/nperm_gc-live_output/rgc.sort"  w l ls 5 notitle,      "output/nperm_gc-live_output/use.sort"  w l ls 4 notitle
