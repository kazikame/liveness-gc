...
plot [:] [:] "output/paraffins_gc-live_output/rch.sort"  w l ls 1 notitle,     "output/paraffins_gc-plain_output/rch.sort" w l ls 2 notitle,     "output/paraffins_gc-freq_output/rch.sort"  w l ls 3 notitle,      "output/paraffins_gc-live_output/use.sort"  w l ls 5 notitle
