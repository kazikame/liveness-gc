...
plot [50e5:51e5] [0:] "output/lambda_gc-live_output/rch.sort"  w l ls 1 notitle,     "output/lambda_gc-plain_output/rch.sort" w l ls 2 notitle,     "output/lambda_gc-freq_output/rch.sort"  w l ls 3 notitle,            "output/lambda_gc-live_output/use.sort"  w l ls 5 notitle
