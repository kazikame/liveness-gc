...
plot [:] [:] "output/huffman_gc-live_output/rch.sort"  w l ls 1 notitle,     "output/huffman_gc-plain_output/rch.sort" w l ls 2 notitle,     "output/huffman_gc-freq_output/rch.sort"  w l ls 3 notitle,      "output/huffman_gc-live_output/use.sort"  w l ls 5 notitle
