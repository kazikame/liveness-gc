...
plot "output/lambda_gc-live_output/rch.sort"  w l ls 2 notitle,     "output/lambda_gc-plain_output/rch.sort" w l ls 1 notitle,     "output/lambda_gc-freq_output/rch.sort"  w l ls 3 notitle,      "output/lambda_gc-live_output/rgc.sort"  w l ls 5 notitle,      "output/lambda_gc-live_output/use.sort"  w l ls 4 notitle
