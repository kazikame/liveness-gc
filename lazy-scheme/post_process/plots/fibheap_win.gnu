...
set xlabel "fibheap (partial)"
set border 3 lw 0

set output "fibheap_win.eps"
set xtics nomirror ("26" 2.6e6, "27" 2.7e6, "28" 2.8e6, "29" 2.9e6)
set ytics nomirror ("33" 33000, "35" 35000, "37" 37000, "31" 31000) 
set autoscale
set grid noxtics
...
plot [2.6e6:2.9e6] [31000:38000] "output/fibheap_gc-live_output/rch.sort"  w l ls 1 notitle,     "output/fibheap_gc-plain_output/rch.sort" w l ls 2 notitle,     "output/fibheap_gc-freq_output/rch.sort"  w l ls 3 notitle,           "output/fibheap_gc-live_output/use.sort"  w l ls 5 notitle
