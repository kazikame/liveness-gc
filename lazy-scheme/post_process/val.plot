...
plot  "output/$1_gc-live_output/rch.sort"  w l ls 3 notitle, \
    "output/$1_gc-plain_output/rch.sort" w l ls 4 notitle, \
    "output/$1_gc-freq_output/rch.sort"  w l ls 2 notitle,  \
    "output/$1_gc-live_output/use.sort"  w l ls 1 notitle
