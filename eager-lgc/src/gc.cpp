...
void* copy(void* node)
{
	...
	else
	{
		...
		//cout << "Copying cell number " << ((cons*)conscell - (cons*)buffer_dead)<<endl;
		++numcopied;
		 ...
		 //gcout << "Copied cell #"<<((cons*)conscell-(cons*)buffer_dead)<<endl;
		return addr;
	}
