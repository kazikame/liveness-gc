...
states.  This can  be  seen in  the cells touched  per  GC for  $huffman$
benchmark in Table~\ref{fig:memory-usage}, even though it uses only 72
cells, number of cells touched is  88.  We have mitigated this problem
by adding checks to avoid  multiple traversals of closure and function
arguments.
