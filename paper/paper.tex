...
\cred{Need to  rewrite this  entire section  need to  probably mention
  some of  these papers at  least i  found by googling  liveness based
  GC,\\ http://www.cs.hmc.edu/~oneill/papers/Simplifiers-MSPC.pdf\\ http://costa.ls.fi.upm.es/papers/costa/AlbertGGZ12.pdf\\ http://hirzels.com/martin/papers/ecoop01-gc-liveness.pdf\\ }
