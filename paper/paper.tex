...
runtime. Consider  a closure  $(app~f~y)$ has a  reference from
the root  set variable $x$. If $x$  is live,  then we  know that the
cell $(app~f~y)$ has  to be copied. To find out  the
liveness of $y$, we need the program point which triggered the
