    ...
    \begin{boxedminipage}{.49\textwidth}
      {\sf
        ...
        $\cal{M_{\mbox{\tiny \length}}} = $ 
            \begin{tabular}{lc}            
              $[$ \\
              $\psi_1 \mapsto \lbrace \px.\sigma_{\length}, \xl.\cbar\sigma_{\length} \rbrace ,$ \\ 
              $\psi_2 \mapsto \lbrace \rbrace , $\\
              $\psi_3 \mapsto \lbrace \pz.\sigma_{\length}, \py.\cbar\sigma_{\length}, $\\
              $\pu.\Lf{\length}{\mbox{1}}{\cbar\sigma_{\length}}, \xl.\acdr\Lf{\length}{\mbox{1}}{\cbar\sigma_{\length}} \rbrace $  \\
              $]$
            \end{tabular} \\
            $\cal{P_{\mbox{\tiny \length}}} = $
              \begin{tabular}{lc}
                $[$ \\
                $\pi_{\mbox{1}} \mapsto \lbrace \psi_1, \psi_2, \psi_3 \rbrace, $ \
                $ \pi_{\mbox{2}} \mapsto \lbrace \psi_1, \psi_2, \psi_3 \rbrace, $ \\
                $ \psi_{\mbox{1}} \mapsto \lbrace \psi_1 \rbrace, $ \
                $ \psi_{\mbox{2}} \mapsto \lbrace \psi_2 \rbrace, $ \
                $ \pi_{\mbox{5}} \mapsto \lbrace \psi_3 \rbrace, $ \\
                $ \pi_{\mbox{6}} \mapsto \lbrace \psi_3 \rbrace, $ \
                $ \pi_{\mbox{7}} \mapsto \lbrace \psi_3 \rbrace $ \\
                $ \psi_{\mbox{3}} \mapsto \lbrace \psi_3 \rbrace $ \\
                $]$
              \end{tabular}\\
              $\cal{M_{\mbox{\tiny \main}}} = $ 
              \begin{tabular}{lc}            
                $[$
                  $\psi_4 \mapsto \lbrace \pw.\sigma_{\mathit{\!all}}, \pb.\Lf{\length}{\mbox{1}}{\sigma_{\mathit{\!all}}}, \ldots  \rbrace $ \
                  $]$
              \end{tabular} \\
              $\cal{P_{\mbox{\tiny \main}}} = $
                \begin{tabular}{lc}
                  $[$ \
                  $\pi_{\mbox{8}} \mapsto \lbrace \psi_4 \rbrace, $ \
                  $ \pi_{\mbox{9}} \mapsto \lbrace \psi_4 \rbrace, $ \
                  $ \pi_{\mbox{10}} \mapsto \lbrace \psi_4 \rbrace, $ \
                  $ \psi_{\mbox{4}} \mapsto \lbrace \psi_4 \rbrace, $ \
                  $ \ldots  $ \
                  $]$  
                \end{tabular}
        \end{tabular}
