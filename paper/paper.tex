...
\begin{enumerate} 
\item Consider a \LET\ definition $:\pi: (\LET~x
...
From  the lemma~\ref{lemna:no-calls-correctness}  it  is clear  that this  cannot
happen.
\end{proof}

For   a    programs   with   functions,   we    use   the   techniques
