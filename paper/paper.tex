...
collections from \warning{1.6X  to 23X} and a decrease  in the minimum
memory requirement from  \warning{1X to 1389X}.  As  an added benefit,
...
creation of closures through the $\LET$ construct.  \warning{ We
...
garbage collection of an earlier minefield step.  \warning{However the
...
the efficiency of the program in general and garbage collectors in
...
\begin{figure*}[h!]
\noindent{\Large \bf A. Minefield semantics}
\begin{center}\footnotesize
