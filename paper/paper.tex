...
Section~\ref{sec:liveness} gave  a context-sensitive liveness analysis%
  \mycomment{\color  {red}  and proved  it  correct  with  reference  to  a  {\em
...
\centering
 ...
 \end{tabular}\\
 (a) Data for Liveness Analysis \\[3pt]
\include{autotable}
\end{table*}
...
reuse the DFAs from earlier analysis if the program has not changed..
