...
Any attempt to dereference a reference \added{that has been declared not live by our analysis} %%with a null-liveness   
...
nullifying statements~\cite{inoue88analysis}.  All compile-time
...
in the space of lazy languages seems to be~\cite{lee05static,Hamilton}
