    ...
    \begin{boxedminipage}{.45\textwidth}
        ...
        \renewcommand{\arraystretch}{1}{
          \begin{uprogram}
            ...
            \UNL{5} \hspace*{.32cm} $\pi_4\!\!:\, (\SRETURN~\psi_2:\pv)$
            ...
            \UNL{7} \hspace*{.34cm} $\pi_8\!\!:\, (\SRETURN~\psi_3:\pz)$)))))))
        \end{uprogram}}
        \renewcommand{\arraystretch}{1}{
	  \begin{uprogram}
	  \UNL{1} $(\DEFINE\ (\main)$
	  ...
	  \UNL{3}   \hspace*{.05cm}$\pi_{10}\!\!:\,      $ (\LET\ \pb\  $\leftarrow$  \ldots \IN 
          ...
          \UNL{5}  \hspace*{.25cm}  $\pi_{12}\!\!:\, (\SRETURN~\psi_4:\pw)))))$
\end{uprogram}}
        %%} 
    \end{boxedminipage}
...
evaluation\footnote{Program   points  which  trigger   evaluation  are
  labelled  with   $\psi$  {\color  {red}  ---slightly   late  in  the
    day}}---\SIF\ conditions  and \SRETURN\ expressions.   We call such
...
\\[1ex]
\mathcal{L}((\SRETURN~\psi:x),\sigma,\Lfonly) &=& \lbrack \mathit{ep} \mapsto
