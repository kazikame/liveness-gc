...
{\color  {Myblue}Section~\ref{sec:defs}  introduces   the  syntax  
  of the  programming  language  considered  in our  analysis and describes describes  a small-step  operational semnatics for it.   We  describe our  liveness
  analysis  for  this  lazy  language  in  Section~\ref{sec:liveness}.
  Section~\ref{sec:computing}  describes   the  formulation   of  the
  ...
  formulation which necessitates the approximation to DFA.   Section~\ref{sec:GC-scheme} discusses  different ways
