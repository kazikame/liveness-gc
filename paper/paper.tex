...
semnatics  for it.   We present  our liveness  analysis for  this lazy
...
\rightsquigarrow
$  $\rho', S, H[\rho'(z) := (H(\rho'(x)),H(\rho'(y)))], e$}     &  \sc{cons} \\
\hline
...
Simplifiers~\cite{ONeill}. They are  described as lightweight daeomons
...
\hline
  ...
  \rho', S, H[\rho'(z) := (H(\rho'(x)),H(\rho'(y)))], e, \cred{\sigma', e_f'}$}     &  \sc{cons} \\
\hline
