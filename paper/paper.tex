...
which might not even exist on the program stack. To overcome this we we carry some extra data 
...
what is found at the creation point. \cred{repeated traversals if sharing}.
