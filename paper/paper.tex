...
of access paths.  First, \bcar\ and \bcdr\ are defined as:
...
\end{align*}
Thus \bcar\ selects those entries in $\sigma$ that have leading \acar, and removes the leading \acar\ from the.
