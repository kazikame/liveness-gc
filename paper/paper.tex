...
closures without using  an explicit stack. Our work  extends this work
and tags  liveness values to evaluated  data, as well as  modfiyng the
liveness associated with closures dynamically  during runtime to make
it more precise.
