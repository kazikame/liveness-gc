...
\warning{Although we  provide an  implementation for  a liveness
based garbage  collection scheme for a lazy  language, we
...
propagated inside closures.
  ...
  liveness  of our  garbage collector. Using
  strictness  analysis  to  eagerly  evaluate  closures
  might release more dead cells to be garbage
