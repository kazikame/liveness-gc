...
the  closure will  be  explored as  usual and  copied  by passing  the
references. Since our liveness analysis  predicts the liveness of data
in its evaluated form only, closures  present a challenge for LGC. LGC
will need  to map the  liveness of the  free variables of  the closure
back  to their  evaluation point.  This  situation can  be handled  in
multiple ways and hence we present 2 algorithms for handling closures.
