...
\added{
\begin{myitemize}
\item We propose a liveness based garbage collection scheme for a lazy
  ...
  garbage    collection   for    lazy    languages.    All    previous
...
\item The  analysis results  in a set  of context-free  grammars along
  ...
  whether to  copy a  cell during garbage  collection translates  to a
...
\item We have implemented a garbage  collector that uses the result of
  ...
  Empirical results  show the effectiveness of  liveness-based garbage
  collection.
\end{myitemize}
}
\todelete{
