    ...
    \begin{boxedminipage}{.51\textwidth}
        ...
        \renewcommand{\arraystretch}{1}{
          \begin{uprogram}
            ...
            \UNL{4} \hspace*{.27cm} $\psi_2\!\!:\, (\SRETURN ~0)$
            ...
            \UNL{7} \hspace*{.34cm} $\psi_3\!\!:\, (\SRETURN ~\pz)$))))))
        \end{uprogram}}
        \renewcommand{\arraystretch}{1}{
	  \begin{uprogram}
	  ...
	  \UNL{2}   \hspace*{.78cm}   $\pi_7\!\!:\,      $ (\LET\ \pb\  $\leftarrow$  \ldots \IN 
          ...
          \UNL{4}  \hspace*{.78cm}  $\psi_{4}\!\!:\,$ (\SRETURN\ \pw)))))))
\end{uprogram}}
        %%} 
    \end{boxedminipage}
            ...
            $\cal{P_{\mbox{\tiny \length}}} = $
              \begin{tabular}{lc}
                ...
                $ \pi_2 \mapsto \lbrace ep_1, ep_2, ep_3
                  \rbrace, $\\
                $~~\psi_1 \mapsto \lbrace ep_1 \rbrace, $ \
                $ \psi_2 \mapsto \lbrace ep_2 \rbrace, $ \
                $ \pi_5 \mapsto \lbrace ep_3 \rbrace, $ \\
                $~~\pi_6 \mapsto \lbrace ep_3 \rbrace, $ \
                $ \pi_7 \mapsto \lbrace ep_3 \rbrace,~ \psi_3 \mapsto \lbrace ep_3 \rbrace~\rbrack$
              \end{tabular}\\
...
%%   path-sensitive means certain prooperties  holding along a path only,
...
evaluation\footnote{Program  points which  trigger  evaluation  are
  labelled with  $\psi$ {\color {red} ---slightly late in the day}}---\SIF\ conditions and  \SRETURN\ expressions.
...
The  expression $\psi:(\SRETURN~x)$  with  a demand  $\sigma$ forces  an
