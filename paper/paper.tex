\documentclass[9pt,draft,nonatbib]{sigplanconf}
\usepackage{etex}
\usepackage{float}
\usepackage{mathrsfs}
%%\usepackage{lineno}
...
as a start  symbol. The grammar for  \var{\Df{\length}{1}} and $\langle
{\sigma_{\length}} \rangle$ comprise of the following productions:
