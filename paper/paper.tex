...
$\emptyset$, if  $\sigma$ itself is $\emptyset$.  To  realize these rules
...
\comment{A paragraph more to explain the illustration on the following lines:
...
$\caption{(a) The grammar rules for $\Df{\length}{1'}$ converted into
