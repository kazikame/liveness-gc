...
From the lemma~\ref{lemma:no-calls-correctness} it  is clear that this
cannot happen. {\color{Myblue}  Too bad - self  reference!! Should this
  be Proposition~\ref{prop:correctness}? }
\end{proof}
