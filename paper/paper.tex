...
complicates  liveness  analysis  itself.    In  addition, laziness
also complicates garbage collection, since, 
 apart  from
...
liveness information is updated with more precise versions.  All this
...
[\;]_{\heap},\, (\mainpgm))$,  in which  $[\;]_\rho$ and $[\;]_{\heap}$  are the
...
\bang\ state.  When $n$ is 0,  the state is $([\;]_\rho,\_, [\;]_{S} ,
            [\;]_{\heap}, e_{\mainpgm}, \sigma_{all})$.  Since the call to
