...
%% We could convert the rules defining $\hookrightarrow$ into productions
%% and  add  them  to the  grammar.  However,  this  results in  an  {\em
%%   unrestricted   grammar}~\cite{hopcraft90toc},  and   the  membership
%% problem for  such grammars is undecidable. \comment{Rewrite  it to say
%%   that this is a CFG with  3 unrestricted rules and the membership for
%%   even this grammar  is undecidable} \comment{State the undecidability
%%   of the decision problem above.}
