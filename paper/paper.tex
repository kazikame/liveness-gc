...
case  of  \fun,  \Lan{1}\  may   have  been  defined  in  terms  of
...
\var{\Df{\fun}{2}} &\rightarrow& \clazy \\
\langle\sigma_{\mathit{\fun}} \rangle &\rightarrow& \clazy \\
\var{\Df{\Sum}{1}} &\rightarrow& \clazy 
