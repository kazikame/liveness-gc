...
\centering
 \begin{tabular}{cccccccccc} \hline
   Program & \verb@lambda@& \verb@nperm@& \verb@treejoin@& \verb@lcss@& \verb@sudoku@& \verb@fibheap@& \verb@nqueens@& \verb@knightstour@& \verb@gc_bench@ \\
   \#NFA Nonterminals & \\
   \#NFA Rules & \\
   \#DFA States & 6296 & 4077& 5110 & 4772 42608 4474 2537 5640 1808 \\
   \#DFA Transitions & \\
   DFA Generation Time(sec) & \\
 \end{tabular}
\include{autotable}
\end{table*}
