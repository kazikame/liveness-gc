...
\begin{table*}[ht!]
\caption{Comparing LGC with liveness for closures and reachability for closures}
\label{tab:compare-live-clo-reach-clo}
\centering
\begin{tabular}
{| l | r | r | r | r |}
\hline
Prog Name & Heap size & Num GC & Reachablity for closure & Liveness for closure \\ \hline
\verb@nqueens(8)@ & 10000 & 183 & 0.0087 & 0.2267\\ \hline
\verb@lambda@&10000&11&0.0010&4.9922\\ \hline
\verb@lcss@&10000&1&0.00008&34.6684\\ \hline
\end{tabular}
\end{table*}
