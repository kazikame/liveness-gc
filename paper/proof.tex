...
$S$.  The heap $H$ is common to all contexts.
...
else, in the presence of sharing,   $d_1$  may  be  evaluated  more  than  once~\cite{Jones87}.    Only after this  is the
actual selection done ({\sc car-select}).
