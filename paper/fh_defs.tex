...
\newcommand{\rot}[1]{\rotatebox{30}{\scalebox{0.8}{#1}}}
\newcommand{\rotmore}[1]{\rotatebox{20}{\scalebox{0.8}{#1}}}

\newcounter{lcount}
\newenvironment{myenumerate}{
\begin{list}{\arabic{lcount}.}
{\usecounter{lcount}\setlength{\topsep}{1mm}\setlength{\itemsep}{0.25mm}
...
\newcommand{\nt}{\ensuremath{N}}
\newcommand{\var}[1]{\raisebox{.4mm}{\scalebox{.8}{\ensuremath{\langle #1\rangle}}}}
%\newcommand{\var}[1]{\psframebox*[fillstyle=solid,fillcolor=lightgray,framesep=0]{\ensuremath{#1}}}
%\newcommand{\var}[1]{\scalebox{.8}{\ensuremath{\widehat{#1}}}}
